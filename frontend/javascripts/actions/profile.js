...
export function getProfileAction() {
  return {type: "GET_PROFILE", payload: axios.get('/profile')}
}
...
export function deleteProfileAction(email, password) {
  return {type: "DELETE_PROFILE", payload: axios.delete('/profile')}
}
